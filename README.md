...
This is a browser-ready distribution of [`@aws-sdk/client-mpa`](https://github.com/aws/aws-sdk-js-v3) modules from AWS SDK for JavaScript v3. It is automatically built and published to a CDN, so developers can use AWS SDKs directly in the browser with zero bundling.
...
```html
<script type="module">
  import { } from "https://cdn.jsdelivr.net/gh/aws-sdk/client-mpa/index.min.mjs";
  // your logic here
</script>
```
...
If a package you want isn’t available yet, [create an issue](https://github.com/aws-sdk/client-mpa/issues/)
...
```js
// Latest
https://cdn.jsdelivr.net/gh/aws-sdk/client-mpa/index.min.mjs

// Specific
https://cdn.jsdelivr.net/gh/aws-sdk/client-mpa@3.844.0/index.min.mjs
```
...
To request support for a new AWS SDK v3 browder package, [open an issue](https://github.com/aws-sdk/client-mpa/issues).
